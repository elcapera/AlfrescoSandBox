...
# **createComment**
> CommentEntry createComment(body, nodeId, fields)
...
CommentBody body = new CommentBody(); // CommentBody | The comment text. Note that you can also provide a list of comments.
...
try {
    CommentEntry result = apiInstance.createComment(body, nodeId, fields);
...
# **updateComment**
> CommentEntry updateComment(body, nodeId, commentId, fields)
...
CommentsApi apiInstance = new CommentsApi();
CommentBody body = new CommentBody(); // CommentBody | The JSON representing the comment to be updated.
String nodeId = "nodeId_example"; // String | The identifier of a node.
String commentId = "commentId_example"; // String | The identifier of a comment.
List<String> fields = Arrays.asList("fields_example"); // List<String> | A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. 
try {
    CommentEntry result = apiInstance.updateComment(body, nodeId, commentId, fields);
    System.out.println(result);
} catch (ApiException e) {
