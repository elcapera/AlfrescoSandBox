...
public class RatingBody {
   ...
   * @return id
  **/
  @Schema(required = true, description = "The rating scheme type. Possible values are likes and fiveStar.")
  public IdEnum getId() {
    return id;
  }
   ...
   * @return myRating
  **/
  @Schema(required = true, description = "The rating. The type is specific to the rating scheme, boolean for the likes and an integer for the fiveStar")
