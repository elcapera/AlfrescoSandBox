 ...
 */
@Schema(description = "A specific preference. ")
...
public class Preference {
   ...
   * @return id
  **/
  @Schema(required = true, description = "The unique id of the preference")
  public String getId() {
    return id;
  }
   ...
   * @return value
  **/
  @Schema(description = "The value of the preference. Note that this can be of any JSON type.")
