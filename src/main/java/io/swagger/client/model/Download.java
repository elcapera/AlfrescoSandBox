...
public class Download {
  ...
  public enum StatusEnum {
    ...
    @SerializedName("DONE")
    DONE("DONE"),
    @SerializedName("MAX_CONTENT_SIZE_EXCEEDED")
   ...
   * @return filesAdded
  **/
  @Schema(description = "number of files added so far in the zip")
   ...
   * @return bytesAdded
  **/
  @Schema(description = "number of bytes added so far in the zip")
   ...
   * @return id
  **/
  @Schema(description = "the id of the download node")
  public String getId() {
    return id;
  }
   ...
   * @return totalFiles
  **/
  @Schema(description = "the total number of files to be added in the zip")
   ...
   * @return totalBytes
  **/
  @Schema(description = "the total number of bytes to be added in the zip")
   ...
   * @return status
  **/
  @Schema(description = "the current status of the download node creation")
