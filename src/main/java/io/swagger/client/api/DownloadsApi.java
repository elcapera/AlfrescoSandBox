...
import io.swagger.client.model.DownloadBodyCreate;
import io.swagger.client.model.DownloadEntry;
...
public class DownloadsApi {
     ...
     * @param body The nodeIds the content of which will be zipped, which zip will be set as the content of our download node. (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createDownloadCall(DownloadBodyCreate body, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createDownloadValidateBeforeCall(DownloadBodyCreate body, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createDownload(Async)");
        }
        
        com.squareup.okhttp.Call call = createDownloadCall(body, fields, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DownloadEntry createDownload(DownloadBodyCreate body, List<String> fields) throws ApiException {
        ApiResponse<DownloadEntry> resp = createDownloadWithHttpInfo(body, fields);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DownloadEntry> createDownloadWithHttpInfo(DownloadBodyCreate body, List<String> fields) throws ApiException {
        com.squareup.okhttp.Call call = createDownloadValidateBeforeCall(body, fields, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createDownloadAsync(DownloadBodyCreate body, List<String> fields, final ApiCallback<DownloadEntry> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createDownloadValidateBeforeCall(body, fields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DownloadEntry>(){}.getType();
