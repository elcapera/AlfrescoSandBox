...
public class AuditApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAuditAppCall(String auditApplicationId, List<String> fields, List<String> include, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAuditAppValidateBeforeCall(String auditApplicationId, List<String> fields, List<String> include, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'auditApplicationId' is set
        if (auditApplicationId == null) {
            throw new ApiException("Missing the required parameter 'auditApplicationId' when calling getAuditApp(Async)");
        }
        
        com.squareup.okhttp.Call call = getAuditAppCall(auditApplicationId, fields, include, progressListener, progressRequestListener);
        return call;
    ...
    public AuditApp getAuditApp(String auditApplicationId, List<String> fields, List<String> include) throws ApiException {
        ApiResponse<AuditApp> resp = getAuditAppWithHttpInfo(auditApplicationId, fields, include);
        return resp.getData();
    }
    ...
    public ApiResponse<AuditApp> getAuditAppWithHttpInfo(String auditApplicationId, List<String> fields, List<String> include) throws ApiException {
        com.squareup.okhttp.Call call = getAuditAppValidateBeforeCall(auditApplicationId, fields, include, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAuditAppAsync(String auditApplicationId, List<String> fields, List<String> include, final ApiCallback<AuditApp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAuditAppValidateBeforeCall(auditApplicationId, fields, include, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AuditApp>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listAuditEntriesForAuditAppCall(String auditApplicationId, Integer skipCount, Boolean omitTotalItems, List<String> orderBy, Integer maxItems, String where, List<String> include, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("omitTotalItems", omitTotalItems));
        if (orderBy != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listAuditEntriesForAuditAppValidateBeforeCall(String auditApplicationId, Integer skipCount, Boolean omitTotalItems, List<String> orderBy, Integer maxItems, String where, List<String> include, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'auditApplicationId' is set
        if (auditApplicationId == null) {
            throw new ApiException("Missing the required parameter 'auditApplicationId' when calling listAuditEntriesForAuditApp(Async)");
        }
        
        com.squareup.okhttp.Call call = listAuditEntriesForAuditAppCall(auditApplicationId, skipCount, omitTotalItems, orderBy, maxItems, where, include, fields, progressListener, progressRequestListener);
        return call;
    ...
    public AuditEntryPaging listAuditEntriesForAuditApp(String auditApplicationId, Integer skipCount, Boolean omitTotalItems, List<String> orderBy, Integer maxItems, String where, List<String> include, List<String> fields) throws ApiException {
        ApiResponse<AuditEntryPaging> resp = listAuditEntriesForAuditAppWithHttpInfo(auditApplicationId, skipCount, omitTotalItems, orderBy, maxItems, where, include, fields);
        return resp.getData();
    }
    ...
    public ApiResponse<AuditEntryPaging> listAuditEntriesForAuditAppWithHttpInfo(String auditApplicationId, Integer skipCount, Boolean omitTotalItems, List<String> orderBy, Integer maxItems, String where, List<String> include, List<String> fields) throws ApiException {
        com.squareup.okhttp.Call call = listAuditEntriesForAuditAppValidateBeforeCall(auditApplicationId, skipCount, omitTotalItems, orderBy, maxItems, where, include, fields, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listAuditEntriesForAuditAppAsync(String auditApplicationId, Integer skipCount, Boolean omitTotalItems, List<String> orderBy, Integer maxItems, String where, List<String> include, List<String> fields, final ApiCallback<AuditEntryPaging> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listAuditEntriesForAuditAppValidateBeforeCall(auditApplicationId, skipCount, omitTotalItems, orderBy, maxItems, where, include, fields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AuditEntryPaging>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param body The audit application to update. (required)
     * @param auditApplicationId The identifier of an audit application. (required)
     * @param fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateAuditAppCall(AuditBodyUpdate body, String auditApplicationId, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateAuditAppValidateBeforeCall(AuditBodyUpdate body, String auditApplicationId, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling updateAuditApp(Async)");
        }
        // verify the required parameter 'auditApplicationId' is set
        if (auditApplicationId == null) {
        ...
        com.squareup.okhttp.Call call = updateAuditAppCall(body, auditApplicationId, fields, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AuditApp updateAuditApp(AuditBodyUpdate body, String auditApplicationId, List<String> fields) throws ApiException {
        ApiResponse<AuditApp> resp = updateAuditAppWithHttpInfo(body, auditApplicationId, fields);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AuditApp> updateAuditAppWithHttpInfo(AuditBodyUpdate body, String auditApplicationId, List<String> fields) throws ApiException {
        com.squareup.okhttp.Call call = updateAuditAppValidateBeforeCall(body, auditApplicationId, fields, null, null);
        Type localVarReturnType = new TypeToken<AuditApp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAuditAppAsync(AuditBodyUpdate body, String auditApplicationId, List<String> fields, final ApiCallback<AuditApp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateAuditAppValidateBeforeCall(body, auditApplicationId, fields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AuditApp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
