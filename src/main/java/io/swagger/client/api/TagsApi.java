...
public class TagsApi {
     ...
     * @param body The new tag (required)
     ...
     */
    public com.squareup.okhttp.Call createTagForNodeCall(TagBody body, String nodeId, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createTagForNodeValidateBeforeCall(TagBody body, String nodeId, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createTagForNode(Async)");
        }
        ...
        com.squareup.okhttp.Call call = createTagForNodeCall(body, nodeId, fields, progressListener, progressRequestListener);
        return call;
     ...
     */
    public TagEntry createTagForNode(TagBody body, String nodeId, List<String> fields) throws ApiException {
        ApiResponse<TagEntry> resp = createTagForNodeWithHttpInfo(body, nodeId, fields);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TagEntry> createTagForNodeWithHttpInfo(TagBody body, String nodeId, List<String> fields) throws ApiException {
        com.squareup.okhttp.Call call = createTagForNodeValidateBeforeCall(body, nodeId, fields, null, null);
     ...
     */
    public com.squareup.okhttp.Call createTagForNodeAsync(TagBody body, String nodeId, List<String> fields, final ApiCallback<TagEntry> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createTagForNodeValidateBeforeCall(body, nodeId, fields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TagEntry>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listTagsCall(Integer skipCount, Integer maxItems, List<String> fields, List<String> include, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listTagsValidateBeforeCall(Integer skipCount, Integer maxItems, List<String> fields, List<String> include, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = listTagsCall(skipCount, maxItems, fields, include, progressListener, progressRequestListener);
        return call;
    ...
    public TagPaging listTags(Integer skipCount, Integer maxItems, List<String> fields, List<String> include) throws ApiException {
        ApiResponse<TagPaging> resp = listTagsWithHttpInfo(skipCount, maxItems, fields, include);
        return resp.getData();
    }
    ...
    public ApiResponse<TagPaging> listTagsWithHttpInfo(Integer skipCount, Integer maxItems, List<String> fields, List<String> include) throws ApiException {
        com.squareup.okhttp.Call call = listTagsValidateBeforeCall(skipCount, maxItems, fields, include, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listTagsAsync(Integer skipCount, Integer maxItems, List<String> fields, List<String> include, final ApiCallback<TagPaging> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listTagsValidateBeforeCall(skipCount, maxItems, fields, include, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TagPaging>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param body The updated tag (required)
     * @param tagId The identifier of a tag. (required)
     * @param fields A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter.  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateTagCall(TagBody body, String tagId, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateTagValidateBeforeCall(TagBody body, String tagId, List<String> fields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = updateTagCall(body, tagId, fields, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TagEntry updateTag(TagBody body, String tagId, List<String> fields) throws ApiException {
        ApiResponse<TagEntry> resp = updateTagWithHttpInfo(body, tagId, fields);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TagEntry> updateTagWithHttpInfo(TagBody body, String tagId, List<String> fields) throws ApiException {
        com.squareup.okhttp.Call call = updateTagValidateBeforeCall(body, tagId, fields, null, null);
        Type localVarReturnType = new TypeToken<TagEntry>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateTagAsync(TagBody body, String tagId, List<String> fields, final ApiCallback<TagEntry> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateTagValidateBeforeCall(body, tagId, fields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TagEntry>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
